...
def _slide_body(index: int, slide_title: str, slide_body: str) -> Image.Image:
    ...
    # 슬라이드 번호
    num_font = _load_font(28, bold=True)
    ...
    wrapped = textwrap.wrap(slide_body, width=22)
    y = 200
    for line in wrapped:
...
def _slide_cta(slide_title: str, slide_body: str) -> Image.Image:
    ...
    wrapped = textwrap.wrap(slide_title, width=14)
    y = 320
    for line in wrapped:
    ...
    bwrapped = textwrap.wrap(slide_body, width=20)
    y += 30
